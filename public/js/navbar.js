...
function addNotification(notification) {
  ...
  newNotification.innerHTML = "<a href=\"/manage-request/".concat(request_id, "\">").concat(message, "</a>");
  ...
  if (!is_read) {
    ...
    markAsReadButton.onclick = function () {
      return markAsRead(id, newNotification);
    };
...
function _markAsRead() {
  _markAsRead = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(notificationId, notificationElement) {
    var csrfToken, counter, count;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          csrfToken = document.querySelector('meta[name="csrf-token"]').getAttribute("content"); // Mark as read on the backend
          _context.next = 3;
          return fetch("/notifications/".concat(notificationId, "/markAsRead"), {
            method: "POST",
            headers: {
...
function _loadNotifications() {
  _loadNotifications = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var userId, response, notifications;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          userId = document.querySelector('meta[name="user-id"]').getAttribute("content");
          _context2.next = 3;
          return fetch("/notifications?user_id=" + userId);
        case 3:

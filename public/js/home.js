...
document.addEventListener("DOMContentLoaded", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
  var csrfToken, userId, searchInput, searchSelect, searchIcon, fetchTailors, _fetchTailors, getQueryParameter, updateURL, initialShopName, initialType, initialPage;
  return _regeneratorRuntime().wrap(function _callee7$(_context7) {
    while (1) switch (_context7.prev = _context7.next) {
      case 0:
        _fetchTailors = function _fetchTailors3() {
          _fetchTailors = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
            var shop_name,
              type,
              page,
              messageElement,
            ...
            return _regeneratorRuntime().wrap(function _callee6$(_context6) {
              while (1) switch (_context6.prev = _context6.next) {
                case 0:
                  shop_name = _args6.length > 0 && _args6[0] !== undefined ? _args6[0] : "";
                  type = _args6.length > 1 && _args6[1] !== undefined ? _args6[1] : "";
                  page = _args6.length > 2 && _args6[2] !== undefined ? _args6[2] : 1;
                  messageElement = document.querySelector("#message");
                  content = document.querySelector(".content"); // Clear previous results
                ...
                case 17:
                  data.tailors.data.forEach(function (tailor) {
                    ...
                    var shop_image = tailor.shop_image ? "".concat(link, "/storage/").concat(tailor.shop_image) : "".concat(link, "/storage/images/default_tailor.jpg");
        ...
        fetchTailors = function _fetchTailors2() {
          return _fetchTailors.apply(this, arguments);
        };
        ...
        searchIcon.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
          var shop_name, type;
